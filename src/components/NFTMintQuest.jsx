        ...
        {!completed ? (
          <button
            ...
            className={`w-full py-3 px-4 rounded-lg font-medium text-sm disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center
              ${activeTask === 1 && !started ? 'bg-pink-600 hover:bg-pink-700 text-white' : 
              activeTask === 2 && started ? 'bg-pink-600 hover:bg-pink-700 text-white' : 
              activeTask === 3 && completed ? 'bg-pink-600 hover:bg-pink-700 text-white' : 
          ...
          >
            {loading ? (
              ...
              <span>
                {!started ? "Mint NFT" : "Continue Minting"}
              </span>
            ) : activeTask === 2 ? (
